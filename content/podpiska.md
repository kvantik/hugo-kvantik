...
или через интернет, а также в других странах.

## Подписка в отделениях Почты России{#pochta}
...
В текущем полугодии подписаться на журнал (по полугодовому индексу) со следующего месяца можно примерно до 10 числа текущего месяца.
По годовому индексу подписка принимается только с 1 сентября примерно по 10  декабря предыдущего года (точные сроки вы можете узнать в своём почтовом отделении).

## Подписка через интернет {#internet}

Подписку на «Квантик» можно оформить, не выходя из дома, на сайте Почты России по ссылке https://podpiska.pochta.ru/press/ПМ068 *(доставка журнала в почтовый ящик или до востребования)*

...
**Обратите внимание**, что этим способом подписка на "Квантик" оформляется не напрямую через редакцию, а непосредственно через Почту России.  После того, как номер выходит из типографии, издательство отгружает журналы на центральный склад Почты России, и дальше сроки доставки уже зависят от работы почты.
